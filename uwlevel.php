...
<head>
    ...
    <title>Underweight Levels</title>
</head>
<body>
<header>
...
<section class="welcome" id="welcome">
   ...
   <div>
   <h1 class="heading" data-aos="zoom">Underweight <span>Exercise Levels</span></h1>
    <br>
    <br>
   </div>
   <div>
    <a href="uwbeg.php" class="btn" alt="uwbeg.php">Beginner</a>
    <br>
    <br>
    
    <a href="uwinter.php" class="btn" alt="uwinter.php">Intermediate</a>
    <br>
    <br>
    <a href="uwadv.php" class="btn" alt="uwadv.php">Advanced</a>
    </div>
</section>
