...
<head>
    ...
    <title>Normalweight Levels</title>
</head>
<body>
<header>
...
<section class="welcome" id="welcome">
   ...
   <div>
   <h1 class="heading" data-aos="zoom">Normalweight <span>Exercise Levels</span></h1>
    <br>
    <br>
    <br>
   </div>
   <div>
    <a href="nwbeg.php" class="btn">Beginner</a>
    <br>
    <br>
    <br>
    
    <a href="nwinter.php" class="btn">Intermediate</a>
    <br>
    <br>
    <br>
    <a href="nwadv.php" class="btn">Advanced</a>
    </div>
</section>
